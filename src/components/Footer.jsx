  ...
  const navigate = useNavigate();
    ...
    return (
        ...
        <div className="flex justify-around p-2">
          ...
          <button className="flex flex-col items-center" onClick={() => navigate('/dashboard/allEnquiry')}>
          ...
          <button className="flex flex-col items-center" onClick={() => navigate('/dashboard/allAdmission')}>
